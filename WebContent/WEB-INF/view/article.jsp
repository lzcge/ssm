...
<c:if test="${not empty user }">
	...
	<div class="day">
		<c:forEach items="${ articlecustomlist}" var="info" >
				<div class="dayTitle">
			<h1><a id="Header1_HeaderTitle" class="headermaintitle" href="finduser.action?username=${info.username }">${info.username }</a></h1>
				...
				<div class="clear"></div>
				<div class="postDesc">posted @ ${info.time } ${info.username }  点赞量${info.upvote }  <a href="answer.action?id=${info.id }" rel="nofollow">评论</a></div>
				<div class="clear"></div>
		 </c:forEach>
	</div>
