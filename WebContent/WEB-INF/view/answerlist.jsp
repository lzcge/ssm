	  ...
	  $.ajax(
		{
			...
			url:'${pageContext.request.contextPath}/addanswer.action?id='<%=request.getParameter("id")%>,
...
<ul id="navList">
	<!-- <li><a style="font-size: 15px" id="blog_nav_sitehome" class="menu" href="http://www.cnblogs.com/">博客园</a></li> -->
	<li><a style="font-size: 15px" id="blog_nav_myhome" class="menu" href="findarticlelist.action">首页</a></li>
	<li><a style="font-size: 15px" id="blog_nav_newpost" class="menu" rel="nofollow" href="https://i.cnblogs.com/EditPosts.aspx?opt=1">新随笔</a></li>
	<li><a style="font-size: 15px" id="blog_nav_contact" accesskey="9" class="menu" rel="nofollow" href="https://msg.cnblogs.com/send/%E7%8E%8B%E4%BC%A0%E6%98%8E">联系</a></li>
	<!-- <li><a style="font-size: 15px" id="blog_nav_admin" class="menu" rel="nofollow" href="https://i.cnblogs.com/">管理</a></li> -->
	<li><a style="font-size: 15px" id="blog_nav_rss" class="menu" href="http://www.cnblogs.com/wcm19910616/rss">订阅</a>
...
<div class="day">
	<c:forEach items="${ answerlist}" var="info" >
		<h1><a id="Header1_HeaderTitle" class="headermaintitle" href="http://www.cnblogs.com/wcm19910616/">${info.username }</a></h1>
			<c:forEach items="${info.answers }" var="answerinfo">
			<div class="dayTitle">
				<a id="homepage1_HomePageDays_DaysList_ctl00_ImageLink" title="Day link" href="http://www.cnblogs.com/wcm19910616/archive/2018/04/20.html">${answerinfo.username }</a>				  
			</div>
			<div class="postTitle">
				<a id="homepage1_HomePageDays_DaysList_ctl00_DayList_TitleUrl_0" class="postTitle2" href="https://www.cnblogs.com/wcm19910616/p/8891815.html">感悟</a>
			</div>
			<div class="postCon"><div class="c_b_p_desc">
			${answerinfo.answercont }<br/>
			<!-- 摘要: 一：公司吐槽与策略 
			...
			<div class="clear"></div>
			<div class="postDesc">posted @ ${answerinfo.time } ${answerinfo.username }  点赞量 </div>
			<div class="clear"></div>
			</c:forEach>
	 </c:forEach>
	 ...
	 <c:if test="${empty user }">
		<div class="left_top" style="z-index: 4">
          <ul class="ul1">            
            <!-- <li><a href="Answer_" >我要留言</a></li>      -->       
            <li><a href="findarticlelist.action" >返回首页</a></li>
          </ul>
		...
		<div class="answerpage" style="z-index: 2">
					<h3 style="color: red;font-size: 40px">请先登录！</h3> 				    
		</div>	
	</c:if>	
	<c:choose>
		<c:when test="${not empty user }">
			<div class="answerpage">		
					<form action="addanswer.action?id=<%=request.getParameter("id")%>" method="post">
						<p>评论内容</p><br/>
						<textarea name="answercont" rows="10" cols="100"></textarea><br/>
